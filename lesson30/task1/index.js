...
console.log(userDataPromise);          // в консоли находится сам промисв состоянии пендинг ,тоесть ожидания  
...
userDataPromise
    .then(function onSuccess(userData) {
        /* ...code here */
        console.log(userData);          // в консоле вывелся обьект со значениеями (имя том , возраст 17)
    });
